        ...
        <div class="panel-body">
            <form action="<%=ctxpath%>/add" method="post">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="studentName" id="studentName" placeholder="学生名字">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="telphone" name="telphone" placeholder="电话">
                </div>
